...
#recipe_img_info, .recipe_ingredients_div, .recipe_content_div,
	.recipe_reply_div {
	width: 80%;
	margin: auto;
	/* border: 1px solid; */
...
<body>
	...
	<div class="YRcontent">
		...
		<div class="YRinnercontent">
			...
			<form id="updateForm" method="post" action="update.re"
				enctype="multipart/form-data">

				<!-- 레시피 글 번호 hidden으로 넘기기 -->
				...
				<div id="recipe_img_info" class="row">
					...
					<div class="recipe_img col-5">
						...
						<div class="recipe_img_wrap">
							...
							현재 사진 : <a href="${ r.recipeChangeName }">${ r.recipeOriginName }</a>
							<!-- 이미지 미리보기 하고싶어 -->

							<input type="hidden" name="recipeOriginName"
								value="${ r.recipeOriginName }"> <input type="hidden"
								name="recipeChangeName" value="${ r.recipeChangeName }">
						</div>
					...
					<div class="recipe_info col-7">
						...
						<div class="recipe_title">
							레시피 제목 <input type="text" id="recipeTitle" name="recipeTitle"
								class="input-text-style" value="${ r.recipeTitle }"
						...
						<div class="difficulty_time">
							...
							<div class="difficulty">
								난이도&nbsp; <select name="difficulty" id="difficulty">
							...
							<div class="time">
								소요 시간&nbsp; <select name="time" id="time">
						...
						<div class="recipe_exp">
							간단 설명
							<textarea name="recipeExplanation" id="recipeExplanation"
								class="input-text-style" placeholder="음식에 대한 간단한 설명을 작성해주세요">${ r.recipeExplanation }</textarea>
						</div>
				...
				<div class="recipe_ingredients_div">
					<h3>🥕 재료</h3> &nbsp; 
					<input type="text" name="servings" class="input-text-style" value="${ i.servings }" style="width: 7%; height: 25px;" required>
					<span id="recipe_servings"> 인분 기준 </span>
					<!-- 인분도 변수임, 나중에 여력이 되면 작성할 때 입력한 인분값을 기본값으로 설정하고 +- 버튼 추가해서 재료 수량 바뀌는거 해보기 -->
						...
						<div class="col">
							<div class="d-flex flex-column">
								<div class="ingredient_category_title">
									주재료 <input id="add_ingredient_btn"
										style="float: right; width: 30px; height: 30px;"
										class="btn btn-sm btn-secondary" type="button" value="+">
								</div>
				...
				<div class="recipe_content_div">
					...
					<div class="recipe_content">
						<textarea wrap="hard" name="recipeContent" id="recipe_content_area" class="input-text-style" placeholder="만드는 방법을 순차적으로 작성해주세요">${ r.recipeContent }</textarea>
					</div>
	...
	<script>
        ...
        document.getElementById("addIngredient").addEventListener("click", function () {
            ...
            <!-- 또다시...-->
         // 원래 내용 가져오기
            var originalContent = document.getElementById("yourTextAreaId").value; // 여기서 "yourTextAreaId"는 원본 내용이 있는 <textarea>의 ID여야 합니다
