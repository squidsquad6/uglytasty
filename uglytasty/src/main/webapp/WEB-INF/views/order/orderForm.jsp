...
<!-- 
	...
	p : productNo, productName, explanation, price, sale / changeName, fileLevel / quantity / 
		salePrice, totalPrice, deliveryIncludePrice
 -->
...
<title>Insert title here</title>
 <style>
	...
	#receiverName, #receiverPhone, #addressMain, #addressDetail, #select_request {
		padding-left: 10px;
		font-size:14px;
	}
...
<body>
	...
	<div class="all">
        ...
        <form id="order" action="">
            ...
            <p>주소</p>
            <input type="text" id="addressMain" name="" placeholder="주소를 검색하세요." style="width: 595px; margin-bottom: 5px;">
            <input type="button" id="address_btn" onclick="addressAPI();" value="검색"><br>
            <input type="text" id="addressDetail" name="" placeholder="상세주소를 입력해주세요."> <br><br>
            ...
            <div class="orderProduct">
                ...
                <div class="orderProductInfo">
                    ...
                    <span style="font-weight:bold; color:#ff6741;">${ p.quantity }</span>개</p>
                </div>
            </div>
            ...
            <table id="paymentInfo">
                ...
                <tr>
                    <td>내가 담은 금액</td>
                    <td align="right" id="total"><fmt:formatNumber value="${ p.totalPrice }" pattern="#,###"/>&nbsp;원</td>
                </tr>
                <tr>
                    <td>배송비</td>
                ...
                <tr id="totalPrice">
                    ...
                    <td style="padding-top:40px;">
                    	...
                    	<fmt:formatNumber var="totalPriceFormat" value="${ p.deliveryIncludePrice }" pattern="#,###" />
