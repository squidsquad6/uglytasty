                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <th>제목 *</th>
                            <td>
                                <input type="text" name="title" id="title" placeholder="제목을 입력해주세요." class="input">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th>고정글 설정 *</th>
                            <td>
                                <input type="checkbox" name="upfix2" id="upfix2" class="ckbox" checked>
                                <label for="upfix2"></label>
                                <input type="hidden" name="upfix" id="upfix" value="Y">
                            </td>
                        </tr>
